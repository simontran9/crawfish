...
/// `Scanner` is compromised of the file content `source`, the current index `current_index`, the current character `current_char` and the index of the next character `read_index`
